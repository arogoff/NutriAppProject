...
public class MaintainWeightGoal implements Goal{
    public String type;
    ...
    public MaintainWeightGoal(String type, int calorieLimit, int goalWeight){
        this.type = type;
    ...
    public void createGoal(String height, int weight, int age, String gender) {
        ...
        if(gender.equalsIgnoreCase("m")){
            calorieLimit = (int) ((66.5 + (13.75 * (weight * 0.4535924)) + (5.003 * heightCm) - (6.775*age)) * 1.2);
        } else if (gender.equalsIgnoreCase("f")) {
            calorieLimit = (int) ((655.1 + (9.563 * (weight * 0.4535924)) + (1.850 * heightCm) - (4.676*age)) * 1.2);
        }
    }
